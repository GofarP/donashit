...
281.6C409.597 320.911 394.601 360.22 364.61 390.213Z" fill="#4C51BF" stroke="#4C51BF" strokewidth="2"
...
01-2-2v-2z">
    ...
    Request::is('admin/category*') ? ' bg-gray-700 bg-opacity-25 textgray-100' : 'text-gray-500' }}" href="{{ route('admin.category.index') }}">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                        xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" strokelinejoin="round" stroke-width="2" d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2
0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z"></path>
                    </svg>
                    <span class="mx-3">Kategori</span>
                </a>
                <a class="flex items-center mt-4 py-2 px-6 hover:bggray-700 hover:bg-opacity-25 hover:text-gray-100 {{
    Request::is('admin/campaign*') ? ' bg-gray-700 bg-opacity-25 textgray-100' : 'text-gray-500' }}" href="#">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                        xmlns="http://www.w3.org/2000/svg">
...
6 3 6h-8.5l-1-1H5a2 2 0 00-2 2zm9-13.5V9">
                ...
                <a class="flex items-center mt-4 py-2 px-6 hover:bggray-700 hover:bg-opacity-25 hover:text-gray-100 {{
    Request::is('admin/donatur*') ? ' bg-gray-700 bg-opacity-25 textgray-100' : 'text-gray-500' }}" href="#">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                        xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" strokelinejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6
0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z">
                ...
                <a class="flex items-center mt-4 py-2 px-6 hover:bggray-700 hover:bg-opacity-25 hover:text-gray-100 {{
    Request::is('admin/donation*') ? ' bg-gray-700 bg-opacity-25 textgray-100' : 'text-gray-500' }}" href="#">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                        xmlns="http://www.w3.org/2000/svg">
...
134
gray-100' : 'text-gray-500' }}" href="#">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                        xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" strokelinejoin="round" stroke-width="2" d="M5.121 17.804A13.937 13.937 0 0112 16c2.5
                    ...
                    <button @click="sidebarOpen = true" class="textgray-500 focus:outline-none lg:hidden">
                        <svg class="h-6 w-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M4 6H20M4 12H20M4 18H11" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke- 135 linejoin="round" />
                        </svg>
                    </button>
                </div>
                <div class="flex items-center">
